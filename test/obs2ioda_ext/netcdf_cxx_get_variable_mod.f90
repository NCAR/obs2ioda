...
contains
    ...
    function netcdfGetVarInt(netcdfID, varName, values, groupName)
        ...
        integer(c_int), allocatable, target, intent(out) :: values(:)
        ...
        type(c_ptr) :: c_values
        integer(c_int), pointer :: f_values_ptr(:)
        ...
        netcdfGetVarInt = c_netcdfGetVarInt(netcdfID, c_groupName, c_varName, c_values)
        call c_f_pointer(c_values, f_values_ptr, [varSize])
        values = f_values_ptr
    ...
    function netcdfGetVarInt64(netcdfID, varName, values, groupName)
        ...
        type(f_c_string_t) :: f_c_string_varName
        type(c_ptr) :: c_values
        integer(c_long), pointer :: f_values_ptr(:)
        ...
        allocate(values(varSize))
        c_values = c_loc(values)
        netcdfGetVarInt64 = c_netcdfGetVarInt64(netcdfID, c_groupName, c_varName, c_values)
        call c_f_pointer(c_values, f_values_ptr, [varSize])
        values = f_values_ptr
    ...
    function netcdfGetVarReal(netcdfID, varName, values, groupName)
        ...
        type(f_c_string_t) :: f_c_string_varName
        type(c_ptr) :: c_values
        real(c_float), pointer :: f_values_ptr(:)
        ...
        allocate(values(varSize))
        c_values = c_loc(values)
        netcdfGetVarReal = c_netcdfGetVarReal(netcdfID, c_groupName, c_varName, c_values)
        call c_f_pointer(c_values, f_values_ptr, [varSize])
        values = f_values_ptr
    ...
    function netcdfGetVarString(netcdfID, varName, values, groupName)
        ...
        c_values = f_c_string_1D_values%to_c(tmpData)
