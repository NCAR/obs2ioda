...
contains
   ...
   subroutine read_write_gnssro(infile, outdir, nfgat, hour_fgat)
      ...
      do idx_window = 1, nfgat
         ...
         call write_gnssro_data(gnssro_data, output_file_date, idx_window, gnssro_bufr_info%nobs_max, output_file_name)
      enddo
   ...
   subroutine write_gnssro_data(gnssro_data, datetime_file, idx_window, maxobs, outfile)
